  ...
  function handleAddExperience(event) {
    ...
    return (
      ...
      <div className="form-wrapper">
          <label htmlFor="name" className="bold-text">Name of employer: </label>
          <input
              type="text"
              id="name"
              value={name}
      ...
      <div className="form-wrapper">
          <label htmlFor="title" className='bold-text'>Job title: </label>
          <input
              type="text"
              id="title"
              value={title}
      ...
      <div className="form-wrapper">
          <label htmlFor="description" className='bold-text'>Description:</label>
      </div>
      <textarea
          id="description"
          value={description}
      ...
      ></textarea>
      <div className="form-wrapper">
          <label htmlFor="link" className='bold-text'>Link:</label>
          <input
              type="text"
              id="link"
              value={link}
